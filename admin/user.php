...
//$requiredcolumns = array('lastaccess');
    ...
    if (!$users) {
        ...
        //$table->head[] = $country;
        //TEKNET
        $table->head[] = 'corsolaurea';
        $table->head[] = 'corsoanno';
        ...
        foreach ($users as $user) {
            ...
            //$row[] = $user->country;
            //TEKNET
            $row[] = profile_display_custom_field($user->id, 'corsolaurea');
            $row[] = profile_display_custom_field($user->id, 'corsoanno');
            $row[] = $strlastaccess;
            if ($user->suspended) {
                foreach ($row as $k=>$v) {
